...
export const getPrecinctYear = (year) => {
  ...
  return [2019, 2015, 2012, 2011, 2010, 2008, 2007, 2004, 2003, 1983].find(
    (y) => year >= y
  )
}

export function fetchGeojsonData(dataDomain, year) {
  return fetch(
    `https://${dataDomain}/precincts-${getPrecinctYear(year)}.geojson`
  ).then((data) => data.json())
}
